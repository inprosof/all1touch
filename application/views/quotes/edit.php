                ...
                <form method="post" id="data_form">
								...
								<div id="customer">
									...
									<div id="customer_pass">
										...
										<select name="n_praz_venc" id="n_praz_venc" class="form-control round">
											<?php 
												echo '<option value="' . $invoice['prop_due'] . '">--' . $invoice['propdue_name'] . '--</option>';
								...
								<div class="form-group row">
									<div class="col-sm-8">
										<label for="invoi_type"
											   class="caption"><?php echo 'Orçamento nº (numeração provisória)' ?> <strong><?php echo $invoice['tid']; ?></strong></label>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6"><label for="invocieduedate"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control round required"
                                                   name="invocieduedate"
                                                   placeholder="Due Date" autocomplete="false" data-toggle="datepicker" <?php if ($this->aauth->get_user()->roleid < 5) echo 'disabled' ?> value="<?php echo dateformat($invoice['invoiceduedate']) ?>">
											<span class="input-group-addon" title="<?php echo 'A data inserida tem que ser no formato: dd-mm-aaaa';?>"><i class="fa fa-info fa-2x"></i></span>
                                        </div>
                                    </div>
								</div>
					...
					<div class="row">
                        <div class="col">
                            ...
                            <textarea class="summernote" name="propos" id="contents" rows="1"><?php echo $invoice['proposal'] ?></textarea></div>
                    </div>
					...
					<input type="hidden" value="quote/editaction2" id="action-url2">
