                    ...
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
								...
								<div id="customer_pass">
									Prazo de vencimento
									<select name="n_praz_venc" id="n_praz_venc" class="form-control round required">
										<?php 
...
A numeração final só é atribuída depois de escolher a opção 'Guardar e finalizar Documento'.";?>"><i class="fa fa-info fa-2x"></i></span>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
											...
											<select id="invoi_serie" name="invoi_serie" class="form-control round select-box">
												<?php 
					...
					<div class="row">
                        <div class="col">
                            ...
                            <textarea class="summernote required" name="propos" id="contents" rows="1"></textarea></div>
                    </div>
