            ...
            <div id="invoice-template" class="card-body">
                <div class="row">
					...
					<div class="title-action">
						...
						><span class="fa fa-retweet"></span>'.$this->lang->line('Change Status').'</a>';
						}?>
						
						<?php if ($invoice['status'] == 'accepted' || $invoice['status'] == 'customer_approved') {
							echo '<a href="#pop_model2" data-toggle="modal" data-remote="false"
						...
						><span class="fa fa-share"></span>Converter em Nota de Encomenda</a>';
						}?>
						<div class="btn-group">
						...
						<a href="<?php echo $link; ?>" class="btn btn-primary mb-1"><i class="fa fa-globe"></i> <?php echo $this->lang->line('Preview') ?>
						</a>
					</div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_model2">
                    <div class="row">
                        <div class="col mb-1">
							<?php echo $this->lang->line('quote as invoice') ?>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_model3">
                    <div class="row">
                        <div class="col mb-1">
							Converter documento em Nota de Encomenda?
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" class="form-control required"
                        ...
                        <button type="button" class="btn btn-default"
                                data-dismiss="modal"><?php echo $this->lang->line('Close') ?></button>
                        <a class="btn btn-primary" href="<?php echo base_url('purchase/quote_perc_convert?qo=' . $invoice['iid'] . '&token=' . $validtoken); ?>"><?php echo $this->lang->line('Yes') ?></a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col mb-1"><label for="pmethod"><?php echo $this->lang->line('Mark As') ?></label>
                            <select name="status" class="form-control mb-1">
								...
								<option value="customer_approved">Aprovado pelo Cliente</option>
