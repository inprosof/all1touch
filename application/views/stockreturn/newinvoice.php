    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Order') ?> <?php echo $this->lang->line('From') ?>
                <a href='#'
...
A numeração final só é atribuída depois de escolher a opção 'Guardar e finalizar Documento'."; ?>"><i
                    ...
                    <input type="hidden" value="stockreturn/action3" id="action-url">
                    <input type="hidden" value="stockreturn/action4" id="action-url2">
