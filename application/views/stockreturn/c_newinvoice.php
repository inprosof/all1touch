                                ...
                                <div class="form-group row">
									<div class="col-sm-8">
										<label for="invoi_type"
                                               class="caption">Cliente Devolução Nº<strong><?php echo $lastinvoice + 1 ?> (numeração provisória)</strong></label>
...
A numeração final só é atribuída depois de escolher a opção 'Guardar e finalizar Documento'.";?>"><i class="fa fa-info fa-2x"></i></span>
					...
					<input type="hidden" value="stockreturn/action2" id="action-url2">
