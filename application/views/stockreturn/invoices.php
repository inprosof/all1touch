    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Suppliers') . ' ' . $this->lang->line('Stock Return') ?> <a
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="invoices_st" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                       width="100%">
                    <thead>
                    <tr>
                        <th>Nº</th>
