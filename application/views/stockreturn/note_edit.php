...
<button type="button" data-rowid="' . $i . '" class="btn btn-danger removeProd" title="Remove"> <i class="icon-minus-square"></i> </button>
                         ...
                         <input type="hidden" name="unit[]" id="unit-' . $i . '" value="' . $row['unit'] . '"><input type="hidden" name="hsn[]" id="unit-' . $i . '" value="' . $row['code'] . '">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td align="left" colspan="2"><input type="text" class="form-control shipVal"
                                                                        ...
                                                                        echo edit_amountExchange_s($invoice['shipping'], $invoice['multi'], $this->aauth->get_user()->loc); ?>">( <?php echo $this->lang->line('Tax') ?> <?php echo $this->config->item('currency'); ?>
                        ...
                        <input type="hidden" value="<?php echo $this->common->taxhandle_edit($invoice['taxstatus']) ?>"
                        ...
                        <input type="hidden" value="<?php echo $invoice['ship_tax_type']; ?>" name="ship_taxtype"
                               id="ship_taxtype">
                        <input type="hidden" value="<?php echo amountFormat_general($invoice['ship_tax']); ?>" name="ship_tax"
                               id="ship_tax">
