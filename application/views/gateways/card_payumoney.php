                            ...
                            <div class="col">
                                <div class="form-group text-xs-center">
                                    ...
                                    <img class="bg-white round mt-1" style="max-width:30rem;max-height:10rem"
                                         src="<?php echo base_url('assets/gateway_logo/' . $gid . '.png') ?>">
                                    <input type="hidden" class="form-control" name="gateway" value="<?php echo $cid ?>">
                    ...
                    <div class="col-md-6 credit-card-box">
                        ...
                        <section onload="submitPayuForm()">
                            ...
                            <form action="<?php echo $action; ?>" method="post" name="payuForm">
                                ...
                                <input type="hidden" name="firstname" id="firstname" value="<?php echo $invoice['name'] ?>"/>
                                <input type="hidden" name="email" id="email" value="<?php echo $invoice['email'] ?>"/>
                                <input type="hidden" name="productinfo"
                                       value="Payment for invoice <?php echo $invoice['tid'] ?>">
                                <input type="hidden" name="surl"
                                       value="<?php echo base_url() . 'billing/secureprocess?inv=' . $invoice['iid'] . '&g=' . $cid ?>"/>
                                <input type="hidden" name="furl"
                                       value="<?php echo base_url() . 'billing/secureprocess?inv=' . $invoice['iid'] . '&g=' . $cid ?>"/>
                                <input type="hidden" name="service_provider" value="payu_paisa" size="64"/>
                                <input type="hidden" name="curl"
                                       value="<?php echo base_url() . 'billing//card?id=' . $invoice['iid'] . '&itype=inv&token=' . $token ?>"/>
