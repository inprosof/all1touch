            ...
            <div class="card-body m-2">
                ...
                <input type="hidden" class="form-control" name="token" value="' . $token . '"/>'; ?>
                    ...
                    <div class="col-md-6 credit-card-box">
                        ...
                        <form action="secureprocess?inv=<?php echo $invoice['iid'] . '&g=' . $gateway['id'] ?>" method="POST">
                            <script
                                    ...
                                    data-notes.shopping_order_id="<?php echo $invoice['iid'] ?>"
                            ...
                            <input type="hidden" name="shopping_order_id" value="<?php echo $invoice['iid'] ?>">
                        </form>
