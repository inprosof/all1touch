    ...
    <div class="card card-block yellow-top">
        <div class="card-header">
            <h5 class="title"><a class="btn-back" onclick=history.go(-1)>
                ...
                </a><?php echo $this->lang->line('Change Customer Password') ?>(<?php echo $customer['name'] ?>)
            </h5>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label"
                           for="password"><?php echo $this->lang->line('New Password') ?></label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6" id="paiCompanyUpdate">
                        <input type="submit" id="submit-data" class="btn btn-success margin-bottom"
                               value="<?php echo $this->lang->line('Update customer') ?>"
