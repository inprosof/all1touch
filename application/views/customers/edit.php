									...
									<div class="form-group row">
										...
										<label class="col-sm-12" for="taxid">Deve ser um valor único</label>
                                            <input type="text" placeholder="<?php echo $this->lang->line('IRS Number') ?>"
                                                   class="form-control margin-bottom b_input" name="taxid" id="taxid" value="<?php echo $customer['taxid'] ?>">
                                        </div>
                                    </div>
									<hr>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Company"
                                                   class="form-control margin-bottom b_input" name="company" id="company_1" value="<?php echo $customer['company'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="address"
                                                   ...
                                                   id="mcustomer_address1" value="<?php echo $customer['address'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="phone"
                                                   ...
                                                   id="mcustomer_phone_s" value="<?php echo $customer['phone_s'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="email"
                                                   ...
                                                   id="mcustomer_email_s" value="<?php echo $customer['email_s'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="address_s"
                                                   ...
                                                   id="mcustomer_address1_s" value="<?php echo $customer['address_s'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
