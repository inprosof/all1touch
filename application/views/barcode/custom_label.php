...
<html lang="en">
 <head>
  ...
  body
{
  margin: 0; size: <?php echo $style['width'] ?>mm <?php echo $style['height'] ?>mm;
      font-size: <?php echo $style['font_size'] ?>pt;
}

  @page {
            margin: 0;
            size: <?php echo $style['width'] ?>mm <?php echo $style['height']+1 ?>mm;
        }
    </style>
