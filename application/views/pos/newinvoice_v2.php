...
<form method="post" id="data_form">
    <div class="row ">
        <div class="col-md-6 card p-mobile">
			<input type="hidden" value="<?= $prefix['pos']; ?>" name="pref_fac" id="pref_fac">
			<input type="hidden" value="<?= $prefix['rc']; ?>" name="pref_rc" id="pref_rc">
                ...
                <div class="col p-mobile">
                    <table id="pos_list" class="table-responsive tfr pos_stripe">
                        ...
                        <tr class="item_header bg-gradient-directional-purple white">
                            <th width="10%"
                                class="text-center">Qtd.</th>
                            <th width="20%"
                                class="text-center">Value</th>
                            <th width="10%"
                                class="text-center">Prod.(%)</th>
                            <th width="10%"
                   ...
                   <!--     <div class="row mt-1">
					...
					<div class="row mt-1">
                        <div class="col-3"><input type="hidden" value="0" id="subttlformwithholding"
                                                  name="subtotalwithholding"> <input type="hidden" value="0"
                                                                          id="custom_withholding"><strong><?php echo $this->lang->line('Total').' '.$this->lang->line('Withholding') ?></strong>
                        </div>
                        <div class="col-6"><span
                                    class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>
                            <span id="subttlwithholding" class="lightMode">0</span></div>
                    </div>
                    <div class="row mt-1">
                        <div class="col-3">
                ...
                <div class="tab-content px-1 pt-1">
                    ...
                    <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="base-tab2">
                        <div class="row">
							...
							<div class="col-4 blue text-xs-center"><?php echo $this->lang->line('Withholding') ?>
								<select name="taxwithholdings" id="taxwithholdings" class="selectpicker form-control round teal">
