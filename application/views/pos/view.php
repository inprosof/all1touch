                ...
                <div class="row">
                    ...
                    <div class="">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                           ...
                           <!--<a href="<?php /*echo 'edit?id=' . $invoice['iid']; */?>" class="btn btn-warning mb-1" <?php /*if ($this->aauth->get_user()->roleid < 5 || $invoice['status'] == 'paid' || $invoice['status'] == 'canceled') echo 'hidden' */?>><i
							...
							<a href="<?php echo base_url('billing/view?id=' . $invoice['iid'] . '&token=' . $validtoken); ?>" class="btn btn-blue-grey mb-1"><i
							...
							<div class="btn-group ">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item"
									   href="<?php echo base_url('invoices/printinvoice?id=' . $invoice['iid'] . '&token=' . $validtoken); ?>"><?php echo $this->lang->line('Print') ?></a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item"
									   href="<?php echo base_url('invoices/printinvoice?id=' . $invoice['iid'] . '&token=' . $validtoken); ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
						...
						<div id="invoice-customer-details" class="row pt-2">
							<div class="col-md-6 col-sm-12 text-xs-center text-md-left">
								<ul class="px-0 list-unstyled">
									<li class="text-bold-800"><li>Código: <?php echo $invoice['csd']?></li>
									<a href="<?php echo base_url('customers/view?id=' . $invoice['cid']) ?>"><strong
											   class="invoice_a"><?php echo $invoice['name'] . '</strong></a></li><br>' ?>
