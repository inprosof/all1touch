                ...
                <div class="col p-mobile">
                   ...
                   <div class="row mt-1">
                    ...
                    <div class="row mt-1">
                        ...
                        <span id="subttlform_in" class="lightMode"><?php echo $invoice['tax'] ?></span></div>
                    </div>
					<div class="row mt-1">
                        <div class="col-3">
					...
					<div class="row mt-1">
                        <div class="col-3">
							<input type="hidden" value="0.00" name="discs_tot_val" id="discs_tot_val" value="<?php echo $invoice['total_discount_tax'] ?>">
							<strong>Total do documento</strong>
                        </div>
                        <div class="col-6"><span  class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>
                        <span id="discs_tot" class="lightMode"><?php echo $invoice['discount'] ?></span></div>
                    </div>
...
<script type="text/javascript">
    ...
    $.ajax({
        ...
        dataType: 'html',
        method: 'POST',
        data: 'cid=' + $('#categories').val() + '&wid=' + $('#warehouses option:selected').val() + '&' + crsf_token + '=' + crsf_hash + '&bar=' + $('#bar_only').prop('checked'),
