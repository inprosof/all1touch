...
<div id='printbox'>
    <h2 style="margin-top:0" class="text-center"><?php echo $loc['cname'] ?></h2>
    ...
    <table class="inv_info">
        ...
        <?php if ($invoice['taxstatus'] == 'cgst') {
            ...
            <tr>
                ...
                <td><b><?php echo amountExchange($gst, $invoice['multi'], $invoice['loc']) ?></b> (<?php echo $rate ?>%)</td>
            </tr>
            <tr>
        ...
        <?php } else if ($invoice['taxstatus'] == 'igst') {
            ...
            <tr>
                ...
                <td><b><?php echo amountExchange($invoice['tax'], $invoice['multi']) ?></b> (<?php echo $row['tax'] ?>%)</td>
            </tr>
        <?php } ?>
        <tr>
