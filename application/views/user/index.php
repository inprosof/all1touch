                        ...
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <a href="#" class="close" data-dismiss="alert">&times;</a> <div class="message">' . $response . '</div>
                                ...
                                <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1">
                                    <span><?php echo $this->lang->line('Are you a client ?') ?></span></p>
                                <div class="card-body">
...
<script type="text/javascript" src="<?php echo assets_url(); ?>app-assets/vendors/js/charts/jquery.sparkline.min.js"></script>
...
<script src="<?php echo assets_url(); ?>app-assets/js/scripts/forms/form-login-register.js"></script>
