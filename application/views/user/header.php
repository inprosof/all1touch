...
<head>
    ...
    <title>All 1 Touch - Autenticação</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>app-assets/vendors/css/forms/icheck/icheck.css">
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>app-assets/vendors/css/forms/icheck/custom.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN STACK CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>app-assets/<?php echo LTR ?>/pages/login-register.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>assets/css/style.css">
    <!-- END Custom CSS-->
    <!-- END Custom CSS-->
    ...
    <script src="<?php echo assets_url(); ?>app-assets/vendors/js/forms/validation/jqBootstrapValidation.js"></script>
    <script src="<?php echo assets_url(); ?>app-assets/vendors/js/forms/icheck/icheck.min.js"></script>
