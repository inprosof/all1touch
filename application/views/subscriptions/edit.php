								...
								<div class="form-group row">
									<div class="col-sm-8">
										<label for="invoi_type"
											   class="caption"><?php echo 'Subscrição Nº (numeração provisória)' ?> <strong><?php echo $invoice['tid']; ?></strong></label>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6"><label for="reccur" class="caption"><?php echo $this->lang->line('Next Payment After') ?></label>
										<select name="reccur" class="selectpicker form-control">
											<?php 
											echo '<option value="' . $invoice['r_time'] . '">--';
											echo 'Tempo Escolhido '.$invoice['r_time'].'--</option>';
											?>
