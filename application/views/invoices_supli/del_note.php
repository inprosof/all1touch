...
<div class="invoice-box">
        ...
        <tr>
            ...
            <td class="myw">
                <table class="top_sum">
                    ...
                    <tr>
                        <td><?php echo $this->lang->line('Invoice'). ' de '.$this->lang->line('Supplier')?></td>
                        <td><?php echo $invoice['irs_type'] . ' '.$invoice['serie'].'/'.$invoice['tid'] ?></td>
                    </tr>
                    <tr>
                        <td>DO Date</td>
    ...
    echo '<br><div class="sign">' . $this->lang->line('Authorized person') . ' (' . $employee['name'] . ') '. user_role($employee['roleid']) .'</div><div class="sign1"><img src="' . base_url('userfiles/employee_sign/' . $employee['sign']) . '" width="160" height="50" border="0" alt=""><div class="signr">_____________________________<br>' . $this->lang->line('Received by') . ' &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div></div><hr><strong>Obs:</strong><div class="terms">' . $invoice['notes'] . '';

    echo '<br><strong>' . $invoice['termtit'] . '</strong><br>' . $invoice['terms'];
    ?></div>
</div>
</body>
</html>