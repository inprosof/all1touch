    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Order') ?> <?php echo $this->lang->line('From') ?><a id="addSupplierbut" href='#'
                                                                                                   class="btn btn-primary btn-sm btn-new"
                                                                                                   data-toggle="modal"
                                                                                                   data-target="#addSupplier" <?php if ($order > 0) echo ' hidden' ?>>
                ...
                <form method="post" id="data_form">
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
							<input type="hidden" value="0" name="typeinvoicesuppl" id="typeinvoicesuppl">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                <div class="form-group row">
                                    <div class="frmSearch col-sm-12"><label for="cst"
                                                                            class="caption" <?php if ($order > 0) echo ' hidden' ?>><?php echo $this->lang->line('Search Supplier') ?> </label>
                                    ...
                                    <div class="col-sm-6"><label class="caption"><?php echo $this->lang->line('TAX ID'); ?></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control round required"
                                                   ...
                                                   value="<?php echo $csd_tax ?>" <?php if (!$this->aauth->get_user()->roleid == 5 && !$this->aauth->get_user()->roleid == 7) echo 'disabled' ?>/>
                                        </div>
                                    </div>
...
A numeração final só é atribuída depois de escolher a opção 'Guardar e finalizar Documento'."; ?>"><i
                        ...
                        <table id="myTable" class="table-responsive tfr my_stripe">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="left" colspan="2"><span
                                    ...
                                    <span id="discs_tot" class="lightMode">0.00</span><input type="hidden" value="0.00"
                                                                                             name="discs_tot_val"
                                                                                             id="discs_tot_val"></td>
                            </tr>
                            <tr class="sub_c" style="display: table-row;">
                    ...
                    <input type="hidden"
                           ...
                           name="ship_rate"
                           id="ship_rate">
                    <input type="hidden" value="<?php echo $this->common->disc_status()['ship_tax']; ?>"
                           name="ship_taxtype"
                           id="ship_taxtype">
...
<div class="modal fade" id="choise_docs_related" role="dialog">
	...
	Nota: A pesquisa não é feita em documentos em rascunho ou anulados e apenas considera os documentos disponíveis para serem relacionados respeitando os restantes filtros de pesquisa aplicados.';?>"><i class="fa fa-info fa-2x"></i></span>
					...
					<select name="choise-doc-type" class="form-control b_input crequired" id="choise-doc-type">
						...
						<option value="7">Notas de Encomendas</option>
						<option value="111">Pedidos de Garantias</option>
					</select>
