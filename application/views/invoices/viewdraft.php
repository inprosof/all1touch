						 ...
						 <div class="btn-group ">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item"
								   href="<?php echo base_url('invoices/printinvoice?id=' . $invoice['iid'] . '&ty=1&token=' . $validtoken); ?>"><?php echo $this->lang->line('Print') ?></a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item"
								   href="<?php echo base_url('invoices/printinvoice?id=' . $invoice['iid'] . '&ty=1&token=' . $validtoken); ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
