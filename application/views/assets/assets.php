    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                Categorias de Ativos<a href="<?php echo base_url('assests/addc') ?>"
                                       class="btn btn-primary btn-sm btn-new" <?php if ($this->aauth->premission(96) || $this->aauth->get_user()->roleid == 5 || $this->aauth->get_user()->roleid == 7) echo ''; else echo 'hidden' ?>>
