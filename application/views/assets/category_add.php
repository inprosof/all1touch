    ...
    <div class="card card-block">
        ...
        <div class="card-body">
            <form method="post" id="data_form" class="form-horizontal">
                <h5><?php echo $this->lang->line('Add new') . ' '. $this->lang->line('Category') ?></h5>
                <hr>
                <div class="col-sm-12">
				...
				<div class="col-sm-12">
                    <label class="col-form-label" for="cat_type">Tipo Ativo</label>
                    <div class="col-sm-6">
				...
				<input type="hidden" name="cat_type_id" id="cat_type_id" value="<?php if($catpai != null) echo $catpai['type'];?>">
