    ...
    <div class="card yellow-top">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="evtystable" class="table table-striped table-bordered dataex-res-constructor" cellspacing="0"
                       width="100%">
                    <thead>
                    <tr>
                        <th>#</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#evtystable').DataTable({
            ...
            <?php datatable_lang();?>
            "ajax": {
                "url": "<?php echo site_url('events/evt_load_list')?>",
                "type": "POST",
