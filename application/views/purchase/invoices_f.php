<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Notas de Encomenda Fornecedores<a
                        href="<?php echo base_url('purchase/create_f') ?>"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<input type="hidden" id="convert-ext" name="convert-ext" value="1">
...
<div class="modal fade" id="choise_docs_related" role="dialog">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
			...
			<input type="hidden" id="relations-ext" name="relations-ext" value="1">
            <div class="modal-header">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="action-url2" value="purchase/delete_i">
	...
	$(document).ready(function () {
		...
		function draw_data(start_date = '', end_date = '') {
			$('#po').DataTable({
				...
				'order': [],
				'ajax': {
					'url': "<?php echo site_url('purchase/ajax_list?ext=1')?>",
					'type': 'POST',
					'data': {
