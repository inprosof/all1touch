...
<table>
    <tr>
        ...
        <td> <?php echo '<div class="col-xs-6 col-sm-6 col-md-6">
                    <p>' . $this->lang->line('Amount') . ' ' . $this->lang->line('Debit') . ' : ' . amountExchange($trans['debit'], 0, $trans['loc']) . ' </p><p>' . $this->lang->line('Amount') . ' ' . $this->lang->line('Credit') . ' : ' . amountExchange($trans['credit'], 0, $trans['loc']) . ' </p>'; ?></td>
    </tr>
</table>
