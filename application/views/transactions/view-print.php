...
<table>
    <tr>
        ...
        <td> <?php echo '<div class="col-xs-6 col-sm-6 col-md-6">
                    <p>' . $this->lang->line('Debit') . ' : ' . amountExchange($trans['debit'], 0, $this->aauth->get_user()->loc) . ' </p><p>' . $this->lang->line('Credit') . ' : ' . amountExchange($trans['credit'], 0, $this->aauth->get_user()->loc) . ' </p>
					<p>Método: ' . $trans['methodname'] . '</p>
					<p>' . $this->lang->line('Type') . ' : ' . $trans['type'] . '</p>'; 
				?></td>
    </tr>
</table>
