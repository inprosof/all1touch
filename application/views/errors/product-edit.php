        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <input type="hidden" name="pidedi" value="<?php echo $product['pid'] ?>">
                    <div class="form-group row">
						...
						<div class="col-sm-4">
							...
							<select name="product_class" class="form-control required">
                                <?php
                                echo '<option value="' . $cat_ware['claid'] . '">' . $cat_ware['clatit'] . ' (S)</option>';
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
                            ...
                            <select id="sub_cat" name="sub_cat" class="form-control select-box required">
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								...
								<input type="text" name="product_price" id="product_price" class="form-control required"
									   ...
									   onkeypress="return isNumber(event)" onkeyup="rowTotalSupl('0'), billUpyogSupl()"
						...
						<table class="table-responsive tfr my_stripe">
							...
							if (is_array(@$irs_produts[0])) {
								foreach ($irs_produts as $row) {
									$sleccom = "";
									if($row['t_como'] == 1 || $row['t_como'] == "1")
									{
										$sleccom = 'checked="checked"';
									}
									echo '<tr >
										<td><input type="text" class="form-control required" name="tax_n[]" id="tax_n-' . $i . '" value="' . $row['t_name'] . '"></td>
										<td><input type="text" readonly class="form-control text-center" id="tax_val-' . $i . '" name="tax_val[]" value="' . $row['t_val'] . '"></td>
										<td><input type="checkbox" class="form-control text-center" id="tax_como-' . $i . '" name="tax_como[]" '.$sleccom.'></td>
										<input type="hidden" class="pdIn" name="pid[]" id="pid-' . $i . '" value="' . $row['p_id'] . '">
						...
						<table class="table-responsive tfr my_stripe">
							...
							foreach ($suppliers_produts as $row) {
								echo '<tr >
									...
									<td><input type="text" onkeyup="rowTotalSupl(' . $i . ')" class="form-control text-center" id="supli_pr_c-' . $i . '" name="supli_pr_c[]" value="' . $row['supli_pr_c'] . '"></td>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
							...
							<input type="text" placeholder="Total Items in stock"
                                   ...
                                   value="<?php echo $product['qty'] ?>" value="0">
						</div>
