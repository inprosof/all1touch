            ...
            <form method="post" id="data_form">
                ...
                <div class="form-group row">
					...
					<div class="col-sm-4"><label class="col-form-label"
                        ...
                        <select name="product_class" class="form-control required"><option value=""><?php echo $this->lang->line('Please Select') ?></option>
                            <?php
                ...
                <div class="form-group row">
					<div class="col-sm-4">
						<label class="col-form-label required" for="product_warehouse"><?php echo $this->lang->line('Warehouse') ?>*</label>
                        <select name="product_warehouse" class="form-control"><option value=""><?php echo $this->lang->line('Please Select warehouse') ?></option>
                            <?php
                    ...
                    <div class="col-sm-4">
						<label class="col-form-label required" for="product_cat"><?php echo $this->lang->line('Product Category') ?>*</label>
                        <select name="product_cat" id="product_cat" class="form-control"><option value=""><?php echo $this->lang->line('Please Select Category') ?></option>
                            <?php
                            foreach ($cat as $row) {
                                $cid = $row['id'];
                                $title = $row['title'];
                ...
                <div class="form-group row">
					<div class="col-sm-4">
						<label class="col-form-label"><?php echo $this->lang->line('Purchase Order') .' ' .$this->lang->line('Price');?></label>
                        <div class="input-group">
                            ...
                            <input type="text" name="product_price" id="product_price" class="form-control required"
                                   ...
                                   onkeypress="return isNumber(event)" onkeyup="rowTotalTax('0'), billUpyogProduct()">
                        </div>
                    </div>
					<div class="col-sm-4">
                        ...
                        <div class="input-group">
                            <input type="text" name="product_disc" id="product_disc" class="form-control"
                                   ...
                                   onkeypress="return isNumber(event)" onkeyup="rowTotalTax('0'), billUpyogProduct()" value="0.00">
				...
				<div id="saman-row">
					...
					<table class="table-responsive tfr my_stripe">
						...
						<tr class="item_header bg-gradient-directional-blue white">
							<th width="73%" class="text-center"><?php echo $this->lang->line('Default TAX Rate') ?></th>
							<th width="15%" class="text-center">Valor</th>
							<th width="7%" class="text-center">Cumulativo</th>
						...
						<tr>
							...
							<td><input type="text" readonly class="form-control text-center amnt" id="tax_val-0" name="tax_val[]" value="0.00"></td>
							<td><input type="checkbox" class="form-control text-center" id="tax_como-0" name="tax_como[]"></td>
				...
				<div id="saman-row-supplier">
					...
					<table class="table-responsive tfr my_stripe">
						...
						<tr>
							...
							<td><input type="text" class="form-control text-center" id="supli_ref-0" name="supli_ref[]"></td>
							<td><input type="text" onkeyup="rowTotalSupl('0')" class="form-control text-center" id="supli_pr_c-0" name="supli_pr_c[]"></td>
							<td><input type="text" readonly class="form-control text-center" id="supli_des_c-0" name="supli_des_c[]" value="0.00"></td>
							<td><input type="text" readonly class="form-control text-center" id="supli_des_g-0" name="supli_des_g[]" value="0.00"></td>
							<td><input type="text" readonly class="form-control text-center" id="supli_pr_c_d-0" name="supli_pr_c_d[]" value="0.00"></td>
							<td><input type="text" readonly class="form-control text-center" id="supli_marg_e-0" name="supli_marg_e[]" value="0.00"></td>
							<td><input type="text" readonly class="form-control text-center" id="supli_marg_p-0" name="supli_marg_p[]" value="0.00"></td>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
						<label class="col-form-label" for="product_cat"><?php echo $this->lang->line('Alert Quantity') ?></label>
                        <input type="text" placeholder=""
