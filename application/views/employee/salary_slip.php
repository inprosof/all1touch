<div class="content-body">
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h5 class="title"><?php echo $this->lang->line('Employee Salary Slip') ?></h5>
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="emptable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                    ...
                    <td><a href='" . base_url("employee/generate_slip?id=$aid") . "' class='btn btn-success btn-xs'><i class='fa fa-eye'></i> " . $this->lang->line('Generate Slip') . "</a></td></tr>";
