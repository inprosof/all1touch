					...
					<div class="tab-content px-1 pt-1">
						<div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
								<div class="form-group row">
									<label class="col-sm-6 col-form-label" for="name"> <?php echo $this->lang->line('UserName') ?> <small class="error">(Use Only a-z0-9)</small>
									</label>
									<div class="col-sm-10">
								...
								<div class="form-group row">
									<label class="col-sm-6 col-form-label" for="password"> <?php echo $this->lang->line('Password') ?> <small>(min length 6 | max length 20 | a-zA-Z 0-9 @ $)</small>
									</label>
									<div class="col-sm-10">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
									  <input type="text" placeholder="address" class="form-control margin-bottom required" name="address">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-2 col-form-label" for="city"> <?php echo $this->lang->line('City') ?> </label>
									<div class="col-sm-10">
									  <input type="text" placeholder="City" class="form-control margin-bottom required" name="city">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-2 col-form-label" for="city"> <?php echo $this->lang->line('Region') ?> </label>
									<div class="col-sm-10">
								...
								<div class="form-group row">
									...
									<div class="col-sm-5"><input type="number" placeholder="0.0"
																class="form-control margin-bottom required" id="productivity"
								...
								<div class="form-group row">
									...
									<div class="col-sm-5"><input type="text" placeholder=""
																class="form-control margin-bottom required" id="social_security_number"
								...
								<div class="form-group row">
								  ...
								  <div class="col-sm-5">
									<input type="text" placeholder="" class="form-control margin-bottom required" id="irs_number" name="irs_number">
								  </div>
								</div>

								<div class="form-group row">
								  <label class="col-sm-2 col-form-label" for="name"><?php echo $this->lang->line('Type Employee') ?></label>
								  <div class="col-sm-5">
								...
								<div class="col-sm-6">
								  <div class="form-group">
										<label for="exampleFormControlInput1"><?php echo $this->lang->line('Medical Allowance') ?></label>
										<input type="text" class="form-control" id="medical" name="medical" value="Sem Companhia">
								  </div>
								</div>
						...
						<div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="base-tab2">
							<?php if ($this->aauth->get_user()->roleid >= 0) { ?> <div class="form-group row">
							  ...
							  <div class="form-group row">
									<label class="col-sm-2 col-form-label" for="name"> <?php echo $this->lang->line('Business Location') ?> </label>
									<div class="col-sm-5">
							...
							<div class="form-group row">
								<label class="col-sm-3 col-form-label" for="city"> <?php echo $this->lang->line('Commission') ?> % </label>
								<div class="col-sm-2">
    ...
    $.ajax({
          ...
          success: function(data) {
            $("#notify .message").html(" < strong > " + data.status + " < /strong>: " + data.message);
                $("#notify").removeClass("alert-warning").addClass("alert-success").fadeIn(); $("html, body").animate({
                  scrollTop: $('html, body').offset().top
                }, 200); $("#product_action").remove();
              },
              error: function(data) {
                $("#notify .message").html(" < strong > " + data.status + " < /strong>: " + data.message);
                  $("#notify").removeClass("alert-success").addClass("alert-warning").fadeIn(); $("html, body").animate({
