            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <hr>
                        <h5 class="mb-2"><?php echo $this->lang->line('Account Statement'); ?></h5>
                        <hr>

                        <form action="<?php echo base_url() ?>supplier/statement" method="post" role="form">
                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                                   value="<?php echo $this->security->get_csrf_hash(); ?>">
                            <input type="hidden" name="supplier" value="<?php echo $id ?>">
