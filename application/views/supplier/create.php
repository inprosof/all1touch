    ...
    <div class="card card-block bg-white yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Add New supplier Details') ?>
            </h5>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="tab-content px-1 pt-1">
                                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-12" for="taxid">Verificar contribuinte no sistema
                                            VIES</label>
                                        <div class="col-sm-12">
                                            <label class="col-sm-12" for="taxid">Nota: A verificação dos contribuintes
                                ...
                                <div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="base-tab3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <select name="n_met_pag" class="form-control b_input required" id="n_met_pag">
                                                <option value="">Escolha uma Opção</option>
                                                <?php
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <select name="n_met_exp" class="form-control b_input required" id="n_met_exp">
                                                <option value="">Escolha uma Opção</option>
                                                <?php
                                                echo $expeditions;
                                                ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7" id="paiCompanyUpdate">
