    ...
    <div class="card card-block bg-white yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Edit supplier Details') ?>
            </h5>
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                        <div class="tab-pane active show" id="tab1" role="tabpanel"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           class="form-control margin-bottom b_input required" name="taxid"
                                                           id="taxid" value="<?php echo $supplier['taxid'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-12" for="taxid">Verificar contribuinte no sistema
                                                    VIES</label>
                                                <div class="col-sm-12">
                                                    <div class="alert alert-info" id="alert-info-text" for="taxid">Nota:
                                                        A verificação dos
                                                        contribuintes no Sistema VIES só é possível para as empresas da
                                                        União Europeia! Esta verificação é opcional!
                                                        Escolha o país de origem da empresa que deseja verificar e
                                                        carregue em "Verificar Contribuinte".
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="msupplier_cont_vies"
                                                                    class="form-control b_input"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="Company"
                                                           class="form-control margin-bottom" name="company_1"
                                                           id="company_1" value="<?php echo $supplier['company'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="address"
                                                           ...
                                                           id="address" value="<?php echo $supplier['address'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" placeholder="Region"
                                                               ...
                                                               id="region" value="<?php echo $supplier['region'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <label class="col-form-label"
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" placeholder="PostBox"
                                                               ...
                                                               id="postbox" value="<?php echo $supplier['postbox'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="email"
                                                           ...
                                                           id="email" value="<?php echo $supplier['email'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="website"
                                                           class="form-control margin-bottom" name="website"
                                                           id="website" value="<?php echo $supplier['website'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="base-tab3">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="n_lang" class="form-control b_input required"
                                                            id="n_lang">
                                                        <?php
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-sm-2 col-form-label" for="email">Desconto
                                                    global</label>

                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="desc_glo"
                                                           class="form-control margin-bottom"
                                                           onkeypress="return isNumber(event)" name="desc_glo"
                                                           id="desc_glo" value="<?php echo $supplier['desc_glo'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">

                                                <label class="col-sm-2 col-form-label" for="email">Limite de
                                                    Crédito</label>

                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="limit_cre"
                                                           class="form-control margin-bottom"
                                                           onkeypress="return isNumber(event)" name="limit_cre"
                                                           id="limit_cre" value="<?php echo $supplier['limit_cre'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label"
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="n_praz_venc" class="form-control b_input required"
                                                            id="n_praz_venc">
                                                        <?php
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="n_copy" class="form-control b_input required"
                                                            id="n_copy">
                                                        <?php
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="n_met_pag" class="form-control b_input"
                                                            id="n_met_pag">
                                                        <?php
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="n_met_exp" class="form-control b_input required"
                                                            id="n_met_exp">
                                                        <?php
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
													<textarea rows="5" cols="1" placeholder="obs" placeholder="obs"
                                                              class="form-control margin-bottom" name="obs" id="obs"
                                                              value="<?php echo $supplier['obs'] ?>"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane show" id="tab4" role="tabpanel"
