<div class="card card yellow-top">
    <div class="card-header">
        <h5 class="title">
            <a class="btn-back" onclick=history.go(-1)>
                <i class="bi bi-arrow-left-circle text-info" style="font-size: 1.4rem;"></i>
            </a>
            <?php echo $this->lang->line('Add New Account') ?>
        </h5>
    ...
    <div class="card card-block">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" placeholder="Conta Receitas, Por exemplo.."
                       class="form-control margin-bottom required" name="holder">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="accno"><?php echo $this->lang->line('Account No') ?>
                (IBAN)</label>
            <div class="col-sm-6">
                <input type="text" placeholder="PT50...Por exemplo" class="form-control margin-bottom required"
                       name="accno">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" placeholder="CGD01...Por exemplo" class="form-control margin-bottom required"
                       name="acode">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" placeholder="Valor em caixa inicial" onkeypress="return isNumber(event)"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" placeholder="Caixa, Montepio.." class="form-control margin-bottom  required"
                       name="bank">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" placeholder="CGDIPTPL, Por exemplo..." class="form-control margin-bottom  required"
                       name="branch">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" placeholder="Av. Central, 0000-000..." class="form-control margin-bottom  required"
                       name="address">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6" id="paiCompanyUpdate">
                <input type="submit" id="submit-data" class="btn btn-success margin-bottom"
                       value="<?php echo $this->lang->line('Add Account') ?>" data-loading-text="Adicionando...">
