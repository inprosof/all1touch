...
<body>
<div id="header">GST <?php echo $general['title'] ?></div>
<table class="header_table">
    ...
    <tr>
        ...
        <td>
            <table id="meta">
                <tr>
                    <td class="meta-head"><?php echo $general['title'] ?> #</td>
                    <td><?php echo $general['prefix'] . ' ' . $invoice['tid'] ?></td>
                </tr>
                <tr>

                    <td class="meta-head"><?php echo $this->lang->line('Due Date') ?></td>
                    <td><?php echo dateformat($invoice['invoiceduedate']) ?></td>
                </tr>
                <tr>
                    <td class="meta-head"><?php echo $this->lang->line('Total Amount') ?></td>
...
<table id="items">
    ...
    <tr>
        <td colspan="<?php echo $tcols ?>" class="blank">&nbsp;</td>

    </tr>

    <tr>
        <td colspan="<?php echo $tcols ?>" class="blank">
            <hr>
        </td>
        <td colspan="2" class="total-line"><?php echo $this->lang->line('SubTotal') ?></td>
        <td colspan="2"
...
<div id="terms">
    <h5><?php echo $invoice['termtit'] ?></h5>
