    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Add Business Location') ?></h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content px-1 pt-1">
                            ...
                            <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="base-tab2">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label"
                                           for="type_doc">Tipo Documentos <?php echo $this->lang->line('Default') ?> e
                                        POS</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label"
                                           for="account_d">Conta Documentos <?php echo $this->lang->line('Default') ?> e
                                        POS</label>
                                    <div class="col-sm-6">
