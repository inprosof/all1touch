<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5>Informações da Localização</h5>
								...
								<div class="tab-content px-1 pt-1">
									<div class="tab-pane <?php if($param1 > 0) echo 'active show'; ?>" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
										...
										<div class="form-group row">
											...
											<div class="col-sm-4">
												<input type="submit" id="location-data" class="btn btn-success margin-bottom"
									...
									<div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="base-tab2">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label"></label>
											<div class="col-sm-4">
												<input type="submit" id="location-data1" class="btn btn-success margin-bottom"
													   value="<?php echo $this->lang->line('Edit') ?>" data-loading-text="Adding...">
											</div>
										</div>
									</div>
									<div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="base-tab3">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label"></label>
											<div class="col-sm-4">
												<input type="submit" id="location-data2" class="btn btn-success margin-bottom"
													   value="<?php echo $this->lang->line('Edit') ?>" data-loading-text="Adding...">
											</div>
										</div>
									</div>
									...
									<div class="tab-pane <?php if($param4 > 0 || $param44 > 0) echo 'active show'; ?>" id="tab4" role="tabpanel" aria-labelledby="base-tab4">
										<div id="accordionComunicatAtW" role="tablist" aria-multiselectable="false">
											...
											<div id="accordioncomunicationat" role="tabpanel1" aria-labelledby="headingr" 
												...
												<div class="col-sm-12">
													...
													<div class="form-group row">
														<div class="col-sm-10">
															...
															<div class="input-group">
																<span class="input-group-addon"><?php echo $taxid;?>/</span>
																<input type="text" name="username" class="form-control required"
																	   placeholder="0" aria-describedby="sizing-addon1"
																	   onkeypress="return isNumber(event)" value="<?php if($activation['username'] == '') echo '0'; else echo $activation['username']; ?>">
													...
													<div class="form-group row">
														...
														<div class="input-group">
															<input type="current-password" placeholder="Password" class="form-control margin-bottom crequired" name="password" id="password" value="<?php echo $activation['password'] ?>">
														</div>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-sm-2 col-form-label"></label>
													<div class="col-sm-4">
														<input type="submit" id="location-data3" class="btn btn-success margin-bottom"
															   value="<?php echo $this->lang->line('Edit') ?>" data-loading-text="Adding...">
											...
											<div id="accordionIvaCaix" role="tabpanel2" aria-labelledby="headingriva"
												...
												<div class="col-sm-12">
													...
													<div class="custom-control custom-checkbox">
														...
														<input type="checkbox" class="custom-control-input" name="caixa_4" id="caixa_4_t" value="<?php echo $activation['caixa_vat4'] ?>" <?php if ($activation['caixa_vat4'] == 1) echo 'checked="checked"' ?> <?php if ($activation['caixa_vat1'] == 0 || $activation_caixa['caixa_vat2'] == 0 || $activation_caixa['caixa_vat3'] == 0) echo 'disabled' ?>>
												...
												<div class="form-group row">
													<label class="col-sm-2 col-form-label"></label>
													<div class="col-sm-4">
														<input type="submit" id="location-data4" class="btn btn-success margin-bottom"
															   value="<?php echo $this->lang->line('Edit') ?>" data-loading-text="Adding...">
														<input type="hidden" value="<?php echo $id ?>" name="idloc_caixa">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="tab-pane <?php if($param5 > 0) echo 'active show'; ?>" id="tab5" role="tabpanel" aria-labelledby="base-tab5">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label"></label>
											<div class="col-sm-4">
												<input type="submit" id="location-data5" class="btn btn-success margin-bottom"
													   value="<?php echo $this->lang->line('Edit') ?>" data-loading-text="Adding...">
											</div>
										</div>
									</div>
									<div class="tab-pane <?php if($param6 > 0 || $param7 > 0) echo 'active show'; ?>" id="tab6" role="tabpanel" aria-labelledby="base-tab6">
										<div id="accordionEMAILGG" role="tablist" aria-multiselectable="false">
											...
											<div id="accordionEMAILGGW" role="tabpanel3" aria-labelledby="headingremails" 
										...
										<div id="accordionEMAILSTG" role="tablist" aria-multiselectable="false">
											...
											<div id="accordionEMAILSTGW" role="tabpanel" aria-labelledby="headingrstocks"
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label"></label>
											<div class="col-sm-4">
												<input type="submit" id="location-data7" class="btn btn-success sub-btn" value="<?php echo $this->lang->line('Update') ?>" data-loading-text="Updating...">
											</div>
										</div>
									</div>
									<div class="tab-pane <?php if($param77 > 0) echo 'active show'; ?>" id="tab7" role="tabpanel" aria-labelledby="base-tab7">
										...
										<div id="accordionGER" role="tablist" aria-multiselectable="false">
											...
											<div id="accordionGERW" role="tabpanel" aria-labelledby="headingr"
												 class="card-collapse <?php if ($param77 == 0) echo 'collapse'?>" aria-expanded="false">
												<div class="form-group row">
													<div class="col-sm-12">
													...
													<div class="col-sm-12">
														...
														<div class="input-group">
															<select name="type_doc"
																	class="selectpicker form-control round required">
																<option value="<?php echo $online_pay['doc_default']; ?>" selected>--<?php echo $online_pay['nametipdoc']; ?>--</option>';
																<?php
																	echo $irs_typ;
																?>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label"></label>
											<div class="col-sm-4">
												<input type="submit" id="location-data8" class="btn btn-success sub-btn" value="<?php echo $this->lang->line('Update') ?>" data-loading-text="Updating...">
											</div>
										</div>
									</div>
								</div>
