                                ...
                                <div class="form-group row">
									<div class="col-sm-8">
										<label for="invoi_type"
                                               class="caption"><?php echo $guide['type'].' nº' ?> <strong><?php echo $lastinvoice + 1 ?> (numeração provisória)</strong></label>
...
A numeração final só é atribuída depois de escolher a opção 'Guardar e finalizar Documento'.";?>"><i class="fa fa-info fa-2x"></i></span>
								...
								<td colspan="1">Transporte 
									<div class="col-sm-12">
										...
										<div class="col-sm-12 associate hidden">
											...
											<div class="custom-control custom-checkbox">
												<input value="0" type="text" id="val_save_bd" name="val_save_bd"/>
                    ...
                    <input type="hidden" value="guides/action" id="action-url">
					<input type="hidden" value="guides/action2" id="action-url2">
