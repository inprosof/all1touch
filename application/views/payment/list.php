        ...
        <div class="card-body">
            <table id="catgtable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                ...
                foreach ($gateway as $row) {
                    ...
                    <td><div class='action-btn'> <a href='" . base_url("paymentgateways/edit?id=$cid") . "' class='btn btn-outline-primary btn-sm' title='" . $this->lang->line('Edit') . "'><i class='bi bi-pencil'></i></a></div></td></tr>";
                    $i++;
                }
                ?>
                </tbody>
