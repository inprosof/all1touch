<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('Trending Products') . ' ' . $this->lang->line('Graphical Reports') ?></h5>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <button type="button"
                            ...
                            data-val="week"><?php echo $this->lang->line('This') . ' ' . $this->lang->line('Week') ?></button>
                    <button type="button"
                            class="update_chart btn btn-secondary btn-min-width  btn-lg mr-1 mb-1"
                            data-val="month"><?php echo $this->lang->line('This') . ' ' . $this->lang->line('Month') ?></button>
                    <button type="button"
                            class="update_chart btn btn-success btn-min-width  btn-lg mr-1 mb-1"
                            data-val="year"><?php echo $this->lang->line('This') . ' ' . $this->lang->line('Year') ?></button>
                    <button type="button"
                            class="update_chart btn btn-info btn-min-width  btn-lg mr-1 mb-1"
                            data-val="custom"><?php echo $this->lang->line('Custom Range') . ' ' . $this->lang->line('Date') ?></button>
