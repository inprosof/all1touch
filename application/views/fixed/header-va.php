...
<nav class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-semi-dark navbar-shadow">
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse ss" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="dropdown  nav-item" style="display:none;"><a class="nav-link nav-link-label" href="#"
                    ...
                    <li class="nav-item d-none d-md-block nav-link" style="<?php if (!$this->aauth->premission(5)) echo 'display:none' ?> !important;">
						<a href="<?php echo base_url() ?>pos_invoices/create" class="btn btn-info btn-md t_tooltip" title="Access POS"><i class="icon-handbag"></i>POS</a>
                    </li>
                    ...
                    <li class="nav-item nav-search" style="<?php if (!$this->aauth->premission(120)) echo 'display:none' ?> !important;">
						<a class="nav-link nav-link-search" href="#" aria-haspopup="true" aria-expanded="false" id="search-input"><i class="ficon ft-search"></i></a>
                        <div class="search-input">
                            <input class="input" type="text" placeholder="<?php echo $this->lang->line('Search Customer') ?>"
                                   id="head-customerbox">
                        </div>
                                            ...
                                            <div class="card-collapse collapse mb-1 " id="accordion6" role="tabpanel"
                                                ...
                                                <div class="card-content">
                                                    <ul>
														...
														<li><a class="dropdown-item"
                                                               href="<?php echo base_url(); ?>settings/withholding"><i
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <?php if ($this->aauth->get_user()->roleid == 5 || $this->aauth->get_user()->roleid == 7) { ?>
                <li class="p-1"><select class="form-control"
						onchange="javascript:location.href = baseurl+'settings/switch_location?id='+this.value;"> 
						<?php
							$company = location(0);
							$loc = location($this->aauth->get_user()->loc);
                ...
                <li class="nav-item has-sub <?php if ($this->li_a == "sales" || $this->li_a == "promo" || $this->li_a == "guides") {
                    ...
                    <ul class="menu-content">
						...
						<?php if ($this->aauth->premission(7)) {?>
							<li class="menu-item">
								<a href="<?php echo base_url(); ?>quote"><i class="icon-call-out"></i><?php echo $this->lang->line('Quotes') ?></a>
							</li>
						<?php }?>
            ...
            if ($this->aauth->premission(22) || $this->aauth->premission(25) || $this->aauth->premission(28) || $this->aauth->premission(31) || $this->aauth->premission(32) || $this->aauth->premission(35)) {?>
                <li class="nav-item has-sub <?php if ($this->li_a == "stock") {
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item">
							<a href="<?php echo base_url(); ?>products"><i class="ft-list"></i> <?php echo $this->lang->line('Items Manager') ?></a>
                        </li>
						<?php }?>
			...
			if ($this->aauth->premission(36) || $this->aauth->premission(39) || $this->aauth->premission(42) || $this->aauth->premission(45) || $this->aauth->premission(48) || $this->aauth->premission(49) || $this->aauth->premission(125)) { ?>
                <li class="nav-item has-sub <?php if ($this->li_a == "crm") {
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item">
							<a href="<?php echo base_url(); ?>customers"><i class="ft-users"></i> <?php echo $this->lang->line('Clients') ?></a>
						</li>
						<?php }?>
			...
			if ($this->aauth->premission(50) || $this->aauth->premission(51) || $this->aauth->premission(54) || $this->aauth->premission(57) || $this->aauth->premission(60) || $this->aauth->premission(122)) {?>
				<li class="nav-item has-sub <?php if ($this->li_a == "suppliers") {
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item">
							<a href="<?php echo base_url(); ?>supplier"><i class="ft-target"></i> <?php echo $this->lang->line('Manage Suppliers') ?></a>
						</li>
						<?php }?>
						...
						<li class="menu-item">
                            <a href="<?php echo base_url(); ?>supplier_notes/index?ty=d"><i class="icon-screen-tablet"></i> Notas de Débito</a>
                        </li>
						<?php }?>
            ...
            if ($this->aauth->premission(61) && $this->aauth->premission(62) || $this->aauth->premission(65)) {
				...
				?><li class="menu-item  has-sub <?php if ($this->li_a == "project") {
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>tools/todo"><i class="icon-list"></i> <?php echo $this->lang->line('To Do List'); ?></a>
                        </li>
						<?php }?>
                    </ul>
                </li>
            ...
            if ((!$this->aauth->premission(62) && $this->aauth->premission(117)) && !$runprojead || !$runprojead && $this->aauth->premission(61)) {?>
                <li class="menu-item has-sub <?php if ($this->li_a == "manager") {
                    ...
                    <ul class="menu-content">
						<li class="menu-item">
                            <a class="dropdown-item" href="<?php echo base_url(); ?>manager/projects"><i class="icon-calendar"></i> <?php echo $this->lang->line('Manage Projects'); ?></a>
                        </li>
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>manager/todo"><i class="icon-list"></i> <?php echo $this->lang->line('To Do List'); ?></a>
                        </li>
                    </ul>
                </li>
            <?php }
            if ($this->aauth->premission(68) || $this->aauth->premission(71) || $this->aauth->premission(73) || $this->aauth->premission(76) || $this->aauth->premission(79)) {?>
                <li class="menu-item  has-sub <?php if ($this->li_a == "accounts") {
                    echo ' open';
                } ?>"><a href="#"><i class="icon-calculator"></i><span><?php echo $this->lang->line('Accounts') ?></span></a>
                    <ul class="menu-content">
						...
						<?php }?>
						<?php if ($this->aauth->premission(73) || $this->aauth->premission(76)) {?>
                        ...
                        <li class="menu-item">
							<a href="<?php echo base_url(); ?>transactions/transfers"><i class="icon-wallet"></i> <?php echo $this->lang->line('View Transfers') ?></a>
                        </li>
						<?php }?>
                    </ul>
                </li>
			...
			if ($this->aauth->premission(80) || $this->aauth->premission(83) || $this->aauth->premission(86) || $this->aauth->premission(89) || $this->aauth->premission(92) || $this->aauth->premission(95)) {?>
                <li class="menu-item  has-sub <?php if ($this->li_a == "misc") {
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>tools/notes"><i class="icon-note"></i> <?php echo $this->lang->line('Notes'); ?></a>
                        </li>
						<?php }?>
						<?php if ($this->aauth->premission(83)) {?>
						<li class="menu-item">
                            <a href="<?php echo base_url(); ?>events/events_type"><i class="icon-calendar"></i> <?php echo $this->lang->line('Events Type'); ?></a>
                        </li>
						<?php }?>
						<?php if ($this->aauth->premission(86)) {?>
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>events"><i class="icon-calendar"></i> <?php echo $this->lang->line('Calendar'); ?></a>
                        </li>
						<?php }?>
						<?php if ($this->aauth->premission(89)) {?>
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>tools/documents"><i class="icon-doc"></i> <?php echo $this->lang->line('Documents'); ?></a>
                        </li>
						<?php }?>
						<?php if ($this->aauth->premission(92) || $this->aauth->premission(95)) { ?>
						<li class="menu-item"><a href="#"><i class="ft-layers"></i> <?php echo $this->lang->line('Assets') ?></a>
							<ul class="menu-content">
            ...
            if ($this->aauth->premission(98) || $this->aauth->premission(101) || $this->aauth->premission(102) || $this->aauth->premission(103) || $this->aauth->premission(106) || $this->aauth->premission(108) || $this->aauth->premission(109) || $this->aauth->premission(112)) {?>
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item">
						<a href="#"><i class="ft-users"></i> <?php echo $this->lang->line('Employees') ?></a>
                        <ul class="menu-content">
            ...
            if ($this->aauth->get_user()->roleid == 5 || $this->aauth->get_user()->roleid == 7 || $this->aauth->premission(118)) {?>
				...
				<a href="#"><i class="ft-bar-chart-2"></i><span><?php echo $this->lang->line('Export_Import'); ?></span></a>
					<ul class="menu-content">
						<li class="menu-item">
							<a href="#"><i class="icon-bulb"></i> <?php echo $this->lang->line('Export') ?></a>
							<ul class="menu-content">
								...
								<li><a href="<?php echo base_url(); ?>export/account"><i
										class="fa fa-caret-right"></i> <?php echo $this->lang->line('Account Statements'); ?></a>
								</li>
								<li><a href="<?php echo base_url(); ?>export/people_products"><i
												class="fa fa-caret-right"></i> <?php echo $this->lang->line('ProductsAccount Statements'); ?></a>
								</li>
							</ul>
						</li>
						<li class="menu-item">
							<a href="#"><i class="icon-bulb"></i> <?php echo $this->lang->line('Import') ?></a>
							<ul class="menu-content">
								<li>
									<a href="<?php echo base_url(); ?>import/products"><i class="fa fa-caret-right"></i></i> <?php echo $this->lang->line('Import Products'); ?></a>
								</li>
								<li>
									<a href="<?php echo base_url(); ?>import/customers"><i class="fa fa-caret-right"></i> <?php echo $this->lang->line('Import Customers'); ?></a>
								</li>
							</ul>
						</li>
						<li class="mt-1"></li>
			...
			if ($this->aauth->get_user()->roleid == 5 || $this->aauth->get_user()->roleid == 7 || $this->aauth->premission(119)) {?>
                <li class="menu-item has-sub <?php if ($this->li_a == "taxstsaft") {
                    echo ' open';
                } ?>" ><a href="#"><i class="icon-pie-chart"></i><span><?php echo $this->lang->line('Other Options') ?></span></a>
                    <ul class="menu-content">
						<li class="menu-item">
							<a href="<?php echo base_url(); ?>export/tax_authority"><i class="fa fa-caret-right"></i> <?php echo $this->lang->line('Saft Export'); ?></a>
						</li>
						<li class="menu-item">
							<a href="<?php echo base_url(); ?>export/taxstatement"><i class="fa fa-caret-right"></i> <?php echo $this->lang->line('Tax_Export'); ?></a>
						</li>
						<li class="menu-item">
							<a href="<?php echo base_url(); ?>export/dbexport"><i class="fa fa-caret-right"></i> <?php echo $this->lang->line('Database Backup'); ?></a>
						</li>
						<li class="mt-1"></li>
					</ul>
                </li>
