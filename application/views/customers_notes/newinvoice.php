                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    <div class="frmSearch col-sm-12"><label for="cst"
                                                                            class="caption" <?php if ($relationid > 0) echo ' hidden' ?>><?php echo $this->lang->line('Search Client'); ?></label>
                                ...
                                <div id="customer">
                                    <div class="clientinfo">
                                        ...
                                        <input type="hidden" name="quote_tid" id="quote_tid"
                                               value="<?php if ($relationid > 0) echo $relationid ?>"/>
                                    ...
                                    <div class="col-sm-6"><label
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control round required editdate"
                                                   ...
                                                   value="<?php echo $csd_tax ?>" <?php if ($this->aauth->get_user()->roleid < 5) echo 'disabled' ?>/>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-8">
                                        <label for="invoi_type"
                                               class="caption"><?php echo $type_return ?>
                                            Nº<strong><?php echo $lastinvoice + 1 ?> (numeração
                                                provisória)</strong></label>
