    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Customer') . ' ' . $this->lang->line('Credit Notes') ?> <a
                        data-toggle="modal" data-target="#choise_type_reason" href="#"
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="invoices_c" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                       width="100%">
                    <thead>
                    <tr>
                        <th>Nº</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Escolha em que modo vai efetuar a emissão
                    da <?php echo $this->lang->line('Credit Notes') ?>?</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="action-url" value="docs_interns/delete_i">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="action-url2" value="docs_interns/delete_i">
    ...
    $(document).ready(function () {
        ...
        function draw_data(start_date = '', end_date = '') {
            $('#invoices_c').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('customers_notes/ajax_list?t=1')?>",
                    'type': 'POST',
                    'data': {
