    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Edit') . ' ' . $this->lang->line('Type Docs Tax'); ?>
            </h5>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" placeholder="Type"
                           ...
                           value="<?php echo $irs_typ_doc['type'] ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" placeholder="Description"
                           ...
                           value="<?php echo $irs_typ_doc['description'] ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label"
                ...
                <div class="col-sm-2">
                    <select name="used" class="form-control b_input">
                        <option value="<?php echo $irs_typ_doc['used'] ?>">--<?php echo $irs_typ_doc['nameused'] ?>--
                        </option>
