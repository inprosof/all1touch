                ...
                <form method="post" id="product_action" class="form-horizontal">
                    <div class="card card-block">
						...
						<div class="form-group row">
                            ...
                            <label class="col-sm-2 col-form-label"
                                   for="dual_inv"><?php echo 'Documentos e Avenças ' . $this->lang->line('Account') .' '.$this->lang->line('Default')?></label>
						...
						<div class="form-group row">
                            <label class="col-sm-2 col-form-label"
                                   for="dual_pur"><?php echo 'POS ' . $this->lang->line('Account'). ' '.$this->lang->line('Default') ?></label>
