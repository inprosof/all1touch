                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content px-1 pt-1">
                                    <div class="tab-pane <?php if ($param1 > 0) echo 'active show'; ?>" id="tab1"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group">
                                                    <select name="country" class="form-control b_input required"
                                                            id="country">
                                                        <?php
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <label class=" col-form-label"
                                                       for="foundation"><?php echo $this->lang->line('Foundation Day') ?> </label>
                                                <div class="input-group">
                                        ...
                                        <div class="col-sm-12" id="paiCompanyUpdate">
                                            <input type="submit" id="company_update"
                                    ...
                                    <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="base-tab2">
                                        ...
                                        <div class="col-sm-12" id="paiCompanyUpdate">
                                            <input type="submit" id="company_update1"
                                                   class="btn btn-success margin-bottom"
                                                   value="<?php echo $this->lang->line('Update Company') ?>"
                                    ...
                                    <div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="base-tab3">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="passive_res"
                                                   id="passive_res"
                                                   value="<?php echo $company['passive_res'] ?>" <?php if ($company['passive_res'] == 1) echo 'checked="checked"' ?>>
                                            <label class="custom-control-label"
                                                   for="passive_res"><?php echo "Sujeito passivo não residente em território nacional" ?></label>
                                        </div>
                                        <hr>
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <label class="col-form-label"
                                                       for="data_share"><?php echo $this->lang->line('Product Data Sharing with Other Locations') ?></label>
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="rent_ab"
                                                   id="rent_ab"
                                                   value="<?php echo $company['rent_ab'] ?>" <?php if ($company['rent_ab'] == 1) echo 'checked="checked"' ?>>
                                            <label class="custom-control-label"
                                        ...
                                        <div class="col-sm-12" id="paiCompanyUpdate">
                                            <input type="submit" id="company_update2"
                                                   class="btn btn-success margin-bottom"
                                                   value="<?php echo $this->lang->line('Update Company') ?>"
                                                   data-loading-text="Atualizando...">
                                        </div>
                                    ...
                                    <div class="tab-pane <?php if ($param4 > 0 || $param44 > 0) echo 'active show'; ?>"
                                        ...
                                        <div id="accordionComunicatAtW" role="tablist"
                                             aria-multiselectable="<?php if ($param4 > 0) echo 'true'; else echo 'false'; ?>">
                                            ...
                                            <div id="accordioncomunicationat" role="tabpanel" aria-labelledby="headingr"
                                                 ...
                                                 aria-expanded="false">
                                                <div class="col-sm-12">
                                                    <h5 style="text-align: justify"><?php echo $this->lang->line('saft10') ?></h5>
                                                    <div class="custom-control custom-checkbox">
                                                    ...
                                                    <div class="form-group row div_date_docs">
                                                        <h6 form-group row div_date_docs
                                                            style="text-align: justify"><?php echo $this->lang->line('saft14') ?></h6>
                                                        <label class="col-sm-3 control-label"
                                                               for="date_docs"
                                                               style="text-align: right; font-weight: bold;"><?php echo $this->lang->line('Date') ?>
                                                            :</label>
                                                        <div class="col-sm-5">
                                                    ...
                                                    <div class="form-group row div_date_docs_guide">
                                                        ...
                                                        <label class="col-sm-3 control-label" for="date_docs_guide"
                                                               style="text-align: right; font-weight: bold;"><?php echo $this->lang->line('Date') ?>
                                                            :</label>
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control required"
                                                    ...
                                                    <h5 style="text-align: justify"><?php echo $this->lang->line('saft13') ?></h5>
                                                    <div class="form-group row">

                                                        <label class="col-sm-3 col-form-label" for="username"
                                                               style="text-align: right; font-weight: bold;">ID
                                                            Utilizador:</label>
                                                        <div class="col-sm-5">
                                                            <div class="input-group">
                                                                <span class="input-group-text"><?php echo $loc['taxid']; ?>/</span>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label"
                                                               for="email"
                                                               style="text-align: right; font-weight: bold;"><?php echo $this->lang->line('Your Password') ?>
                                                            :</label>
                                                        <div class="col-sm-5">
                                                            <div class="input-group">
                                                                <input type="current-password" placeholder="Password"
                                                                       ...
                                                                       value="<?php if ($activation['password'] != null) echo $activation['password'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12" id="paiCompanyUpdate">
                                                    <input type="submit" id="company_update3"
                                                           class="btn btn-success margin-bottom"
                                        ...
                                        <div id="accordionIvaCaixAtW" role="tablist"
                                            ...
                                            <div id="accordionIvaCaix" role="tabpanel" aria-labelledby="headingr"
                                                 ...
                                                 aria-expanded="false">
                                                <div class="col-sm-12">
                                                    <h5 style="text-align: justify"><?php echo $this->lang->line('saft17') ?></h5>
                                                    ...
                                                    <h5 style="text-align: justify"><?php echo $this->lang->line('saft19') ?></h5>
                                                    ...
                                                    <h5 style="text-align: justify"><?php echo $this->lang->line('saft21') ?></h5>
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               value="<?php echo $activation['caixa_vat4'] ?>" <?php if ($activation['caixa_vat4'] == 1) echo 'checked="checked"' ?> <?php if ($activation['caixa_vat1'] == 0 || $activation['caixa_vat2'] == 0 || $activation['caixa_vat3'] == 0) echo 'disabled' ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-sm-12" id="paiCompanyUpdate">
                                                    <input type="submit" id="company_update4"
                                                           class="btn btn-success margin-bottom"
                                                           value="<?php echo $this->lang->line('Update') ?>"
                                                           data-loading-text="Atualizando...">
                                                </div>
                                    ...
                                    <div class="tab-pane <?php if ($param5 > 0) echo 'active show'; ?>" id="tab5"
                                        ...
                                        <div class="col-sm-12" id="paiCompanyUpdate" style="padding-top: 15px;">
                                            <input type="submit" id="company_update5"
                                                   class="btn btn-success margin-bottom"
                                                   value="<?php echo $this->lang->line('Update Company') ?>"
                                                   data-loading-text="Atualizando...">
                                        </div>
                                    ...
                                    <div class="tab-pane <?php if ($param7 > 0 || $param6 > 0) echo 'active show'; ?>"
                                        ...
                                        <div class="col-sm-12" id="paiCompanyUpdate">
                                            <input type="submit" id="company_update7"
                                    ...
                                    <div class="tab-pane <?php if ($param77 > 0) echo 'active show'; ?>" id="tab7"
                                        ...
                                        <div id="accordionGER" role="tablist" aria-multiselectable="false">
                                            ...
                                            <div class="col-sm-12" id="paiCompanyUpdate">
                                                <input type="submit" id="company_update8"
                                                       class="btn btn-success sub-btn margin-bottom"
                                                       value="<?php echo $this->lang->line('Update Company') ?>"
                                                       data-loading-text="Atualizando...">
                                            </div>
                                        </div>
