    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Edit') . ' ' . $this->lang->line('Country') ?>
            </h5>
        ...
        <form method="post" id="data_form" class="card-body">
            ...
            <div class="form-group row">
                ...
                <label class="col-sm-2 col-form-label" for="Prefix"><?php echo $this->lang->line('Prefix') ?></label>

                <div class="col-sm-6">
                    <input type="text" placeholder="Prefix"
                           class="form-control margin-bottom b_input" name="prefix"
                           value="<?php echo $country['prefix'] ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <select name="culturs" class="form-control b_input">
                        <option value="<?php echo $country['cultur'] ?>">--<?php echo $country['culturname'] ?>--
                        </option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <select name="memberue" class="form-control b_input">
                        <option value="<?php echo $country['memberue'] ?>">--<?php echo $country['memberuename'] ?>--
                        </option>
