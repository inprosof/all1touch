            ...
            <div class="card-body">
                <form method="post" id="product_action" class="form-horizontal">
					...
					<div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"
                               for="invoiceprefix"><?php echo $this->lang->line('Invoice Prefix').' '.$this->lang->line('Supplier') ?></label>

                        <div class="col-sm-6">
                            <input type="text" placeholder="ff_prefix"
                                   class="form-control margin-bottom  required" name="ff_prefix"
                                   value="<?php echo $prefix['ff'] ?>" maxlength="5">
                        </div>
                    </div>
					...
					<div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"
                               for="invoiceprefix">Recibo <?php echo $this->lang->line('Invoice Prefix') ?></label>

                        <div class="col-sm-6">
                            <input type="text" placeholder="rec_prefix"
                                   class="form-control margin-bottom  required" name="rec_prefix"
                                   value="<?php echo $prefix['rc'] ?>" maxlength="5">
                        </div>
                    </div>
