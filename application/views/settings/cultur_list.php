<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('Culturs') ?> <a href="<?php echo base_url('settings/cultur') ?>"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#htable').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('settings/cltu_list')?>",
                    'type': 'POST',
                    'data': {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo ' '.$this->lang->line('Cultur') ?>
                </div>
                <div class="modal-footer">
                    <input type="hidden" id="object-id" value="">
                    <input type="hidden" id="action-url" value="settings/delete_cultur">
