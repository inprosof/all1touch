						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<select name="serie_iva_caixa" class="form-control b_input">
									<option value="<?php echo $serie['iva_caixa'] ?>">--<?php echo $serie['nameivacaixa'] ?>--</option>
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<select name="serie_pred" class="form-control b_input">
									<option value="<?php echo $serie['predf'] ?>">--<?php echo $serie['namepredf'] ?>--</option>
									<option value="0"><?php echo $this->lang->line('No') ?></option>
									<option value="1"><?php echo $this->lang->line('Yes') ?></option>
								</select>
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<select name="serie_type_com" id="serie_type_com" class="form-control b_input">
									<option value="<?php echo $serie['type_com'] ?>">--<?php echo $serie['nametype_com'] ?>--</option>
