                    ...
                    <div class="card card-block">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-2 col-form-label"
                                   for="discstatus"><?php echo $this->lang->line('Discount') ?> nos Produtos ou Serviços</label>

                            <div class="col-sm-6">
                                <select name="discstatus" class="form-control">
                                    <option value="<?php echo $discship['key1'] ?>">-<?php if ($discship['key1'] == '%') echo 'Após o IVA'; else echo 'Antes do IVA'; ?>-</option>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-2 col-form-label"
                                   for="shiptax_type"><?php echo $this->lang->line('Tax') ?> no <?php echo $this->lang->line('Shipping') ?>?</label>

                            <div class="col-sm-6">
                                <select name="shiptax_type" class="form-control">
                                    <option value="<?php echo $discship['url'] ?>">-<?php if ($discship['url'] == 'incl') echo 'Ligado'; else echo 'Desligado'; ?>-</option>
                        ...
                        <div class="form-group row">
                            ...
                            <small>Será adicionada esta % a todas as faturas. No campo Envio.</small>
                        </div>
