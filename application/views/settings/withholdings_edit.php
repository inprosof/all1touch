        ...
        <div class="card card-block">
            ...
            <form method="post" id="data_form" class="card-body">
				...
				<div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="Tax Cod Send"
                               class="form-control margin-bottom  required" name="tcodesend" value="<?php echo $slabs['val4'] ?>">
                    </div>
                </div>
				...
				<div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="Tax Description"
                               class="form-control margin-bottom  required" name="tdiscription" value="<?php echo $slabs['taxdescription'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
						<select name="ttype" class="form-control b_input">
						<option value="<?php echo $slabs['val3'] ?>">--<?php if ($slabs['val3'] == 'yes'){echo "Exclusive";} else echo $this->lang->line('Inclusive') ?>--</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" value="settings/taxwithholdings_edit" id="action-url">
                    </div>
                </div>
