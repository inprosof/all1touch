    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Edit') . ' ' . $this->lang->line('Cultur') ?>
            </h5>
        ...
        <form method="post" id="data_form" class="card-body">
            <input type="hidden" name="did" value="<?php echo $cultur['id']; ?>">
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" placeholder="Name"
                           class="form-control margin-bottom b_input" name="name" value="<?php echo $cultur['name'] ?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6" id="paiCompanyUpdate">
                    ...
                    <input type="hidden" value="settings/edcultur" id="action-url">
                </div>
            </div>
