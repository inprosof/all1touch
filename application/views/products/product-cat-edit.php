            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" class="form-horizontal">
					...
					<div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label" for="product_catcod">Código</label>

                        <div class="col-sm-6">
                            <input type="text"
                                   class="form-control margin-bottom  required" name="product_catcod"
                                   value="<?php echo $productcat['cod'] ?>">
                        </div>
                    </div>
                    ...
                    <?php if ($productcat['c_type']) { ?>
                        ...
                        <input type="hidden" value="<?php echo $productcat['rel_id'] ?>" name="old_cat_type">
                        <div class="form-group row">
