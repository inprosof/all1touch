				...
				<div class="tab-content px-1 pt-1">
					<div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<label class="col-form-label" for="product_code">Referência<?php echo ' (Último Código: '.$ultimaref.')';?></label>
								<input type="text" placeholder="Product Code"
									   class="form-control required" name="product_code" value="<?php echo $nextcod; ?>">
							</div>
							<div class="col-sm-4">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								...
								<div class="input-group">
									...
									<input type="text" name="product_price" id="product_price" class="form-control required"
										   ...
										   onkeypress="return isNumber(event)" onkeyup="rowTotalTax('0'), rowTotalSupl('0')" value="0.00">
							...
							<div class="col-sm-4">
								...
								<div class="input-group">
									<input type="text" name="product_disc" id="product_disc" class="form-control required"
						...
						<div class="form-group">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" name="product_fav_pos" id="product_fav_pos">
							...
							<div class="custom-control custom-checkbox stockyes hidden">
								<input type="checkbox" class="custom-control-input" name="product_tem_stock" id="product_tem_stock">
						...
						<div class="form-group row stockutility hidden">
							<div class="col-sm-4">
								...
								<select id="sub_classif" name="sub_classif" class="form-control required select-box" disabled="true">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								<small>Se deixar em Branco o sistema cria uma Referência automática em EAN13.</small>
							</div>
						</div>
						<div class="form-group row">
						...
						<div id="accordionWrapa2" role="tablist" aria-multiselectable="true">
							...
							<div id="accordion42" role="tabpanel" aria-labelledby="coupon5"
								...
								<div class="row p-1">
									<div class="col">
										<button class="btn btn-blue tr_clone_add_w">Add</button>
										<hr>
						...
						<div id="saman-row">
							...
							<table class="table-responsive tfr my_stripe">
								...
								<tr>
									...
									<td id="tax_como_td"><input type="checkbox" class="form-control text-center" id="tax_como-0" name="tax_como[]">
									<select hidden
										name="tax_ise[]"
										id="tax_ise-0"
						...
						<div id="saman-row-supplier">
							<table class="table-responsive tfr my_stripe">
								...
								<tr>
									...
									<td><input type="text" onkeyup="rowTotalSupl('0')" class="form-control text-center suppa" id="supli_pr_c-0" name="supli_pr_c[]"></td>
