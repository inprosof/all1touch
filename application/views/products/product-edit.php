    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                <?php echo $this->lang->line('Edit Product') ?></h5>
                    ...
                    <div class="tab-content px-1 pt-1">
                        <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <label class="col-form-label"
                                           for="product_warehouses"><?php echo $this->lang->line('Warehouse') ?>
                                        *</label>
                                    <select name="product_warehouses"
                                            class="form-control required" <?php if ($this->aauth->get_user()->roleid != 7) echo 'disabled' ?>>
                                        <?php
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="product_price" id="product_price"
                                               ...
                                               onkeyup="rowTotalTax('0'), rowTotalSupl('0')"
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="product_disc" id="product_disc" class="form-control"
                                               ...
                                               value="<?php echo $product['disrate'] ?>"><span
                                                class="input-group-text"><i class="bi bi-percent"></i></span>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <label class="col-form-label"
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="product_fav_pos"
                                           id="product_fav_pos"
                                           value="<?php echo $product['fav_pos'] ?>" <?php if ($product['fav_pos'] == 1) echo 'checked="checked"' ?>>
                                ...
                                <div class="custom-control custom-checkbox stockyes <?php if ($cat_ware['typcod'] != 'P') echo 'hidden'; ?>">
                                    <input type="checkbox" class="custom-control-input" name="product_tem_stock"
                                           ...
                                           value="<?php echo $product['tem_stock'] ?>" <?php if ($product['tem_stock'] == 1) echo 'checked="checked"' ?> <?php if ($product['tem_stock'] == 1) echo 'disabled' ?>>
                            ...
                            <div class="form-group row stockutility <?php if ($cat_ware['typcod'] != 'P') echo 'hidden'; ?>">
                                <div class="col-sm-4">
                                    <label class="col-form-label" for="sub_classif">Tipo de Produto (Inventário stocks
                                        AT)</label>
                                    <select id="sub_classif" name="sub_classif"
                                            class="form-control required select-box" <?php if ($cat_ware['typcod'] != 'P') echo 'disabled="true"' ?>>
                                ...
                                <div class="col-sm-4">
                                    <label class="col-form-label"><?php echo $this->lang->line('Stock Units') ?>
                                        *</label>
                            ...
                            <div class="form-group row">
                                ...
                                <span class="input-group-addon" title="<?php echo 'Máximo 250 Caracteres'; ?>"><i
                                ...
                                foreach ($serial_list as $item) { ?>
                                    <div class="form-group serial"><label for="field_s"
                                        ...
                                        <div class="col-lg-10"><input class="form-control box-size"
                                                ...
                                                <?php echo($item['status'] ? 'readonly=""' : 'name="product_serial_e[' . $item['id'] . ']"'); ?>>
                                        </div>
                                    </div>
                                    <?php
                                }
