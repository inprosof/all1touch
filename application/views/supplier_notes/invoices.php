<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Notas de Crédito<a
                        href="<?php echo base_url('supplier_notes/create_c') ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="action-url" value="supplier_notes/delete_i">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="action-url2" value="supplier_notes/delete_i">
