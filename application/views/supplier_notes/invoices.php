    ...
    <div class="card yellow-top">
        <div class="card-header">
            <h5 class="title">
                ...
                Notas de Crédito
				<a href="<?php echo base_url('supplier_notes/create_c') ?>" class="btn btn-primary btn-sm btn-new" <?php if ($this->aauth->premission(58) || $this->aauth->get_user()->roleid == 5 || $this->aauth->get_user()->roleid == 7) echo ''; else echo 'hidden' ?>>
