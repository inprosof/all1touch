        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form">
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <input type="hidden" value="<?php echo $invoice['loc_adress']; ?>" name="compa_adr"
                                       id="compa_adr">
                                <input type="hidden" value="<?php echo $invoice['loc_postbox']; ?>" name="compa_post"
                                       id="compa_post">
                                <input type="hidden" value="<?php echo $invoice['loc_city']; ?>" name="compa_city"
                                       id="compa_city">
                                <input type="hidden" value="<?php echo $invoice['loc_country']; ?>" name="compa_country"
                                       id="compa_country">
                                ...
                                <div id="customer">
                                    <div class="clientinfo">
                                        ...
                                        <hr>
                                        <input type="hidden" name="quote_tid" id="quote_tid"
                                               value="<?php echo $quote ?>"/>
                                        <input type="hidden" name="customer_id" id="customer_id"
                                               value="<?php echo $invoice['csd']; ?>">
                                        <div id="customer_name"><strong><?php echo $invoice['name']; ?></strong></div>
                                    </div>
                                    <div class="clientinfo">
                                        <input type="hidden" name="customer_adr_hi" id="customer_adr_hi"
                                               value="<?php echo $invoice['address']; ?>">
                                        <input type="hidden" name="customer_post_box_hi" id="customer_post_box_hi"
                                               value="<?php echo $invoice['postbox']; ?>">
                                        <input type="hidden" name="customer_city_hi" id="customer_city_hi"
                                               value="<?php echo $invoice['city']; ?>">
                                        <input type="hidden" name="customer_country_hi" id="customer_country_hi"
                                               value="<?php echo $invoice['country']; ?>">
                                        <div id="customer_address1">
                                            <strong><?php echo $invoice['address'] . '<br>' . $invoice['city'] . ',' . $invoice['postbox'] . ',' . $invoice['country']; ?></strong>
                                        </div>
                                    </div>
                                    <div class="clientinfo">
                                        <div type="text"
                                             id="customer_phone"><?php echo 'Telefone: <strong>' . $invoice['phone'] . '</strong><br>Email: <strong>' . $invoice['email']; ?></strong></div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-8">
                                        <label for="invoi_type"
                                               class="caption"><?php echo $this->lang->line('Edit') . ' ' . $invoice['irs_type_s'] . ' nº (numeração provisória)' ?>
                                            <strong><?php echo $invoice['tid']; ?></strong></label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"><label for="invocieno"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-addon"
                                                  title="<?php echo 'Caso tenha que inserir alguma referência do seu cliente na nota de encomenda (Nº de Requisição ou Encomenda, por exemplo), use este campo'; ?>"><i
                                                        class="fa fa-info fa-2x"></i></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="left" colspan="2"><span class="currenty lightMode">
                                    ...
                                    <span id="subttlform_in" name="subttlform_in"
                                          class="lightMode"><?php echo $invoice['subtotal'] ?></span></td>
                            </tr>
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="6" class="reverse_align">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="left" colspan="2"><span
                                    ...
                                    <span id="discs_tot"
                                          class="lightMode"><?php echo $invoice['total_discount_tax'] ?></span>
                                    <input type="hidden" value="<?php echo $invoice['total_discount_tax'] ?>"
                    ...
                    <div id="saman-row-buts">
                        <table id="myTablebuts" class="table-responsive tfr my_stripe">
                            ...
                            <tr class="last-item-row-buts sub_c_buts">
                                ...
                                <td colspan="4"></td>
                                <td>
                                    <input type="submit" class="btn btn-success sub-btn" value="Atualizar Rascunho"
                                           id="submit-data3" data-loading-text="Creating...">
                                    <input type="submit" class="btn btn-success sub-btn btn-lg"
                                           value="Guardar e finalizar Documento" id="submit-data"
                    ...
                    <input type="hidden" value="<?php echo $invoice['format_discount'] ?>" name="discountFormat"
                           id="discount_format">
                    <input type="hidden" value="<?php echo $invoice['ship_tax'] ?>" name="ship_rate" id="ship_rate">
                    <input type="hidden" value="<?php echo $invoice['ship_tax_type'] ?>" name="ship_taxtype"
                           id="ship_taxtype">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content ">
            <form method="post" id="product_action_tax" class="form-horizontal">
                ...
                <h6>Use esta opção para remover uma taxa de IVA aplicada a um artigo ou definir uma isenção da aplicação
                    da taxa de IVA, no caso de remover todas as taxas..</h6>
