...
class Register extends CI_Controller
{
    ...
    public function load_list()
    {
        ...
        foreach ($list as $promo) {
			...
			$option = '<a href="#" class="btn btn-primary btn-sm rounded set-reg" data-id="' . $promo->id . '" data-stat="0"  data-toggle="modal" data-target="#view_register" > ' . $this->lang->line('View') . ' </a> ';
			if ($this->aauth->premission(121) || $this->aauth->get_user()->roleid == 7){
				$option .= '<a href="#" data-object-id="' . $promo->id . '" class="btn btn-danger btn-sm delete-object"><span class="fa fa-trash"></span></a>';
			}
			$row[] = $option;
            $data[] = $row;
        }
