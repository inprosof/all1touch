...
class Supplier extends CI_Controller
{
    ...
    public function load_list()
    {
        ...
        foreach ($list as $suppler) {
            ...
            $row[] = '<div class="action-btn"><a href="supplier/view?id=' . $suppler->id . '" class="btn btn-outline-success btn-sm" title="' . $this->lang->line('View') . '"><span class="bi bi-eye"></span> ' . '</a> <a href="supplier/edit?id=' . $suppler->id . '" class="btn btn-outline-primary btn-sm" title="' . $this->lang->line('Edit') . '"><span class="bi bi-pencil"></span> ' . '</a> <a href="#" data-object-id="' . $suppler->id . '" class="btn btn-outline-danger btn-sm delete-object" title="' . $this->lang->line('Delete') . '"><span class="bi bi-trash"></span></a></div>';
            $data[] = $row;
        }
    ...
    public function translist()
    {
        ...
        foreach ($list as $prd) {
            ...
            $row[] = '<a href="' . base_url() . 'transactions/view?id=' . $pid . '" class="btn btn-primary btn-xs"><span class="bi bi-eye"></span> ' . $this->lang->line('View') . '</a> <a href="#" data-object-id="' . $pid . '" class="btn btn-danger btn-xs delete-object"><span class="bi bi-trash"></span> ' . $this->lang->line('Delete') . '</a>';
            $data[] = $row;
        }
    ...
    public function purchase_list()
    {
        ...
        foreach ($list as $invoices) {
            ...
            if ($invoices->status != 'ended') {
                $row[] = '<a href="' . base_url("purchase/view?id=$invoices->id&ty=0") . '" class="btn btn-danger btn-xs"><i class="bi bi-eye"></i> ' . $this->lang->line('View') . '</a> &nbsp; <a href="' . base_url("purchase/printinvoice?id=$invoices->id&ty=0") . '&d=1" class="btn btn-info btn-xs"  title="Download"><span class="fa fa-download"></span></a>&nbsp; &nbsp;<a href="#" data-object-id="' . $invoices->id . '" class="btn btn-danger btn-xs delete-object"><span class="bi bi-trash"></span></a>';
            } else {
    ...
    public function invoice_list()
    {
        ...
        foreach ($list as $invoices) {
            ...
            if ($invoices->status == 'canceled') {
                $row[] = '<a href="' . base_url("invoices_supli/view?id=$invoices->id&ty=0") . '" class="btn btn-success btn-sm" title="View"><i class="bi bi-eye"></i></a>&nbsp;<a href="' . base_url("invoices_supli/printinvoice?id=$invoices->id") . '&d=1" class="btn btn-info btn-sm"  title="Download"><span class="fa fa-download"></span></a>';
            } else {
                $row[] = '<a href="' . base_url("invoices_supli/view?id=$invoices->id&ty=0") . '" class="btn btn-success btn-sm" title="View"><i class="bi bi-eye"></i></a>&nbsp;<a href="' . base_url("invoices_supli/printinvoice?id=$invoices->id") . '&d=1" class="btn btn-info btn-sm"  title="Download"><span class="fa fa-download"></span></a> <a href="#" data-object-id="' . $invoices->id . '" data-object-tid="' . $invoices->tid . '" data-object-draft="1" class="btn btn-danger btn-sm delete-object"><span class="bi bi-trash"></span></a>';
            }
            $data[] = $row;
        }
        $output = array(
