...
class Locations extends CI_Controller
{
    ...
    public function create()
    {
        if ($this->input->post()) {
            ...
            $this->locations->create($name, $address, $city, $region, $country, $postbox, $phone, $email, $taxid, $image, $cur_id, $ac_id, $wid, $typ_doc,$rent_ab,$zon_fis);
        } else {
    ...
    public function edit()
    {
        if ($this->input->post()) {
			...
			$zon_fis = $this->input->post('zon_fis');
            $this->locations->edit($id, $name, $address, $city, $region, $country, $postbox, $phone, $email, $taxid, $image, $cur_id, $ac_id, $wid, $typ_doc,$rent_ab,$zon_fis);
        } else {
