    ...
    public function assets_list()
    {
        ...
        foreach ($list as $prd) {
            ...
            if ($this->aauth->premission(70) || $this->aauth->get_user()->roleid == 7) {
                $option .= '<div class="action-btn"><a href="' . base_url() . 'assests/edit?id=' . $pid . '" class="btn btn-outline-primary btn-sm" title="' . $this->lang->line('Edit') . '"><span class="bi bi-pencil"></span>  ' . '</a>';
            }
    ...
    public function assetscat_list()
    {
        ...
        foreach ($list as $prd) {
            ...
            if ($this->aauth->premission(97) || $this->aauth->get_user()->roleid == 7) {
                $option .= '<div class="action-btn"><a href="' . base_url() . 'assests/editc?id=' . $pid . '" class="btn btn-outline-primary btn-sm" title="' . $this->lang->line('View') . '"><span class="bi bi-pencil"></span>  ' . '</a>';
            }
