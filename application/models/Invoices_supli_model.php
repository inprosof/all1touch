...
class Invoices_supli_model extends CI_Model
{
    ...
    var $column_search = array('geopos_series.serie', 'geopos_invoices.tid', 'geopos_invoices.invoicedate' , 'geopos_supplier.name', 'geopos_supplier.taxid', 'geopos_invoices.subtotal', 'geopos_invoices.tax', 'geopos_invoices.total', 'geopos_invoices.status');
