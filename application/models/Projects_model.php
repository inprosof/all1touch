...
//project
    ...
    {
        $data = array('name' => $name, 'status' => $status, 'priority' => $priority, 'progress' => $progress, 'cid' => $customer, 'sdate' => $sdate, 'edate' => $edate, 'tag' => $tag, 'phase' => $phase, 'note' => $content, 'worth' => $budget, 'ptype' => $ptype, 'loc' => $this->aauth->get_user()->loc);
    ...
    {
        $this->db->insert('geopos_pms', $data);
    }
}