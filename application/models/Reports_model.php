...
class Reports_model extends CI_Model
{
    ...
    public function get_statements_cat($pay_cat, $trans_type, $sdate, $edate)
    {
        ...
        $this->db->select('*, geopos_trans_cat.cod as cod_cat, geopos_trans_cat.name as name_cat,geopos_config.val1 AS methodname');
        $this->db->from('geopos_transactions');
		$this->db->join('geopos_trans_cat', 'geopos_transactions.cat = geopos_trans_cat.id', 'left');
		$this->db->join('geopos_config', 'geopos_transactions.method = geopos_config.id', 'left');
        $this->db->where($where);
	...
	public function get_customer_previous_debit($pay_acc, $trans_type, $sdate, $edate)
    {
        if ($trans_type == 'All') {
            $where = "payerid='$pay_acc' AND (DATE(date) < '$sdate') AND ext=0";
        } else {
            $where = "payerid='$pay_acc' AND (DATE(date) < '$sdate') AND type='$trans_type' AND ext=0";
        }
		$this->db->select_sum('debit');
        $this->db->from('geopos_transactions');
        $this->db->where($where);
	...
	public function get_customer_previous_credit($pay_acc, $trans_type, $sdate, $edate)
    {
        if ($trans_type == 'All') {
            $where = "payerid='$pay_acc' AND (DATE(date) < '$sdate') AND ext=0";
        } else {
	...
	public function get_supplier_previous_debit($pay_acc, $trans_type, $sdate, $edate)
    {
        if ($trans_type == 'All') {
            $where = "payerid='$pay_acc' AND (DATE(date) < '$sdate') AND ext=1";
        } else {
            $where = "payerid='$pay_acc' AND (DATE(date) < '$sdate') AND type='$trans_type' AND ext=1";
        }
		$this->db->select_sum('debit');
        $this->db->from('geopos_transactions');
        $this->db->where($where);
	...
	public function get_supplier_previous_credit($pay_acc, $trans_type, $sdate, $edate)
    {
        if ($trans_type == 'All') {
            $where = "payerid='$pay_acc' AND (DATE(date) < '$sdate') AND ext=1";
        } else {
	...
	public function get_costumer_credit($pay_acc)
    {
		$this->db->select_sum('credit');
        $this->db->from('geopos_transactions');
	...
	public function get_costumer_debit($pay_acc)
    {
		$this->db->select_sum('debit');
        $this->db->from('geopos_transactions');
        $this->db->where('payerid', $pay_acc);
	...
	public function get_supplier_credit($pay_acc)
    {
		$this->db->select_sum('credit');
        $this->db->from('geopos_transactions');
        $this->db->where('payerid', $pay_acc);
	...
	public function get_supplier_debit($pay_acc)
    {
		$this->db->select_sum('debit');
        $this->db->from('geopos_transactions');
        $this->db->where('payerid', $pay_acc);
